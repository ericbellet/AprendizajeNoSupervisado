...
# Implementación K-medias:
  En primer lugar implemente un algoritmo de k-medias que utiliza como medida de distancia la euclidiana con norma 2, en segundo lugar los centroides iniciales de a_big.csv son los centroides resultantes de aplicarle k-medias a un sample estratificado del conjunto original.
...
```
A partir del subconjunto de **a_big.csv** calculo los centroides que se utilizarán como centroides iniciales.
```{r}
#********************************************************************************
...
```
Ahora utilizando los centroides anteriores, los utilizaremos como centroides iniciales de **a_big.csv**
```{r}
#********************************************************************************
